...
require_once "edituser_lang.php";
						...
						<ul class="navbar-nav ms-auto">
							<li class="nav-item dropdown ms-lg-2">
								...
								<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
									<a class="dropdown-item" href="addingaccounts.php?lang=en"><i
											class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="addingaccounts.php"><i
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="name" class="form-control" id="name" name="name" placeholder=<?= lang("Name") ?> value="<?=  $user_data['name'] ?>" required>

                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="lastname"><?= lang("Lastname") ?></label>
                                                <input type="lastname" class="form-control" id="lastname" name="lastname" placeholder=<?= lang("Lastname") ?> value="<?=  $user_data['name'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                <label for="username"><?= lang("Username") ?></label>
                                                <input type="username" class="form-control" id="username" name="username" placeholder=<?= lang("Username") ?> value="<?=  $user_data['username'] ?>" required>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address" placeholder=<?= lang("Address") ?> value="<?=  $decrypted_address?>" required>
                                        </div>
                                        <div class="mb-3">
											<?php 
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" placeholder="email@gmail.com" value="<?=  $decrypted_email?>" required>
                                        </div>
                                        <div class="row">
											<?php 
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="dui" name="dui" placeholder="00000000-0"value="<?=  $decrypted_dui?>" required>
                                            </div>

						...
						<ul class="navbar-nav ms-auto">
							<li class="nav-item dropdown ms-lg-2">
								...
								<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
									<a class="dropdown-item" href="generateaccount_cashier.php?lang=en"><i class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="generateaccount_cashier.php"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
											<div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="generateaccount_cashier.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
								</div>
							</li>
							<li class="nav-item dropdown ms-lg-2">
								<a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown"
									...
									<table class="table table-striped">
										...
										<thead>
											<tr>
												...
												<th class="d-none d-md-table-cell" style="width:20%"><?= lang("Number Accounts") ?></th>
											</tr>
										</thead>
										<form method="GET">
											<tbody>
												<tr>
													...
													<td class="d-none d-xl-table-cell">
														<?= decryptPayload($user_data["dui"])?>
													</td>
													<td class="d-none d-md-table-cell">
														<?= decryptPayload($user_data["email"])?>
													</td>
													<!-- <td class="d-none d-md-table-cell">
												<?php echo $account_n["accountnumber"] ?>
												</td> -->
													<!-- <?php if ($account_n["accountnumber"] > 0): ?>
													<td class="hidden">

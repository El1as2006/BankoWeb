...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($limit_card)) {
        echo "<script>
                Swal.fire({
                    ...
                    window.location = 'creditcard_view_cashier.php';
                });
              </script>";
        exit;
    }
    ...
    $params = [
        ...
        ':user_type' => 3,
        ':status' => "waiting",
        ':limit_credit' => $limit_card,
        ':requested_card' => "credit",
    ];
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ms-lg-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="creditcard_view_cashier.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown ms-lg-2">
                            <a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown" data-bs-toggle="dropdown">

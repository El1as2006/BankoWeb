...
<div class="col-12">
    ...
    <tr>
        ...
        <th data-sort="username" style="width:25%"><?= lang("Username") ?><span class="sort-arrow"></span></th>
        <th data-sort="dui" style="width:25%">DUI<span class="sort-arrow"></span></th>
        <th data-sort="email" class="d-none d-md-table-cell" style="width:25%">Email<span class="sort-arrow"></span></th>
        <th style="width:25%"><?= lang("Actions") ?></th>
    </tr>
</thead>
                    ...
                    <?php foreach ($users as $data): ?>
                        <tr>
                            ...
                            <td class="table-action">
                                <a href="generateaccount_cashier.php?id=<?= $data['id'] ?>" class="btn btn-outline-primary"><?= Lang("View Acccount") ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>

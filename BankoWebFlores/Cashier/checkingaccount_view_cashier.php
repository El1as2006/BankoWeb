...
require 'checkingaccount_cashier_lang.php';
            ...
            <tbody>
                <tr>
                    ...
                    <td class="table-action">
                        <button onclick="location.href='generateaccount_cashier.php?id=<?= $user_id ?>'" class="btn btn-danger"><?= lang("Return") ?></button>
                    </td>
                    <td class="table-action">
                        <button onclick="location.href='checkingaccount_cashier.php?id=<?= $user_id ?>'" type="button" class="btn btn-success"><?= lang("Request Account") ?></button>
                    </td>
                </tr>
            </tbody>
        </table>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            ...
                            <div class="col-4 text-end">
                                <p class="mb-0">
                                    &copy; 2024 - <a class='text-muted' href='Cashier/index_view_cashier.php'>Banko</a>
                                </p>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                    $stmt = $conn->prepare("SELECT * FROM password_changes");
                                    $stmt->execute();
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="d-none d-md-table-cell" style="width:30%">
                                                <?= lang("New Password") ?>
                                            </th>
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($i as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-xl-table-cell">
                                                    <?php echo decryptPayload($data["old_pass"]) ?>
                                                </td>
                                                <td class="d-none d-xl-table-cell">
                                                    <?php echo decryptPayload($data["new_pass"]) ?>
                                                </td>
                                                <td class="d-none d-xl-table-cell">

                        ...
                        <div class="col-12 col-lg-8 col-xxl-9 d-flex w-100">
                            <div class="card flex-fill">
                                <div class="card-header">
                                    ...
                                    <?php
                                    $stmt1 = $conn->prepare("SELECT u.*, COUNT(a.id) as accounts FROM users u JOIN accounts a on a.owner_id = u.id GROUP BY u.id ORDER BY u.id ASC LIMIT 8;");
                                    $stmt1->execute();
                                ...
                                <table id="datatables-dashboard-projects"
                                    class="table table-striped my-0 tableresponsive">
                                    <thead>
                                        <tr>
                                            <th><?= lang("Name") ?></th>

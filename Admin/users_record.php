...
// Consulta paginadas
$stmt1 = $conn->prepare("SELECT * FROM users_changes LIMIT :limit OFFSET :offset");
...
$stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM users_changes");
$stmt2->execute();

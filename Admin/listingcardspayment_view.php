				...
				<div class="navbar-collapse collapse">
					...
					<li class="nav-item dropdown ms-lg-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="listingcardspayment_view.php?lang=en"><i class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="listingcardspayment_view.php?lang=es"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="listingcardspayment_view.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                            </div>
                        </li>
...
// Consulta paginada
$stmt1 = $conn->prepare("SELECT * FROM cards_payment LIMIT :limit OFFSET :offset");
...
$stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM cards_payment");
$stmt2->execute();
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width:15%" data-sort="amount">
                            <?= lang("Amount") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:20%" data-sort="sender-account">
                            <?= lang("Sender Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:20%" data-sort="card-number">
                            <?= lang("Card Number") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:20%" data-sort="date">
                            <?= lang("Date") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:20%" data-sort="days-left">
                            <?= lang("Days left") ?>
                            <span class="sort-arrow"></span>
                        </th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($data as $row): ?>
                        <tr>
                            ...
                            <td class="d-none d-xl-table-cell"><?= $row["amount"] ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayLoad($row["sender_acn"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayLoad($row["card_number"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= $row["date"] ?></td>
                            <td class="d-none d-md-table-cell"><?= $row["days_left"] ?></td>

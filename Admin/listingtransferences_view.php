                ...
                <ul class="sidebar-nav">
					...
					<li class="sidebar-item">
                        <a class='sidebar-link' href='passrecord_view.php'>
                            <i class="align-middle me-2 far fa-fw fa-users"></i> <span
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                // Consulta paginada
                $stmt1 = $conn->prepare("SELECT * FROM transfers LIMIT :limit OFFSET :offset");
                ...
                $stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM transfers");
                $stmt2->execute();
                ...
                <thead>
                    <tr>
                        <th style="width:20%;" data-sort="id-transference">
                            <?= lang("Id Transference") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:20%" data-sort="amount">
                            <?= lang("Amount") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:20%" data-sort="sent-by">
                            <?= lang("Sent by") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:20%" data-sort="sent-to">
                            <?= lang("Sent to") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th data-sort="transaction-date">

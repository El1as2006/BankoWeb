				...
				<div class="navbar-collapse collapse">
					...
					<li class="nav-item dropdown ms-lg-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								...
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="listingcharges_view.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                            </div>
                        </li>
...
// Consulta paginada
$stmt1 = $conn->prepare("SELECT * FROM charges LIMIT :limit OFFSET :offset");
...
$stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM charges");
$stmt2->execute();
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell" style="width:15%" data-sort="receiver-account">
                            <?= lang("Receiver Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:15%" data-sort="concept">
                            <?= lang("Concept") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:15%" data-sort="date-sent">
                            <?= lang("Date Sent") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:25%" data-sort="date-fulfilled">
                            <?= lang("Date Fulfilled") ?>
                            <span class="sort-arrow"></span>
                        </th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($data as $row): ?>
                        <tr>
                            ...
                            <td class="d-none d-xl-table-cell"><?= $row["concept"] ?></td>
                            <td class="d-none d-md-table-cell"><?= $row["date_sent"] ?></td>
                            <td class="d-none d-xl-table-cell"><?= $row["date_fulfilled"] ?></td>

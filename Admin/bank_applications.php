					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								<a class="dropdown-item" href="bank_applications.php?lang=en"><i
										class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="bank_applications.php?lang=es"><i
										class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="bank_applications.php?lang=de"><i
			...
			<main class="content">
				<div class="container-fluid">
						...
						<div class="card">
							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									$stmt_select_requests = $conn->prepare("SELECT * FROM user_requests WHERE status = 'waiting' AND request_type = 'create'");
												...
												<td>
													<form method="post">
														<input type="hidden" name="request_id"
															value="<?= $request['id'] ?>">
														<input type="hidden" name="request_pass"
															value="<?= $request['pass'] ?>">
														<button type="submit" class="btn btn-success"
															name="accept"><?= lang("Accept") ?></button>
														<button type="submit" class="btn btn-danger"
															name="reject"><?= lang("Reject") ?></button>
													</form>
												</td>
											</tr>
										<?php endforeach; ?>
						...
						<div class="card">
							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									$stmt_select_requests = $conn->prepare("SELECT * FROM user_requests WHERE status = 'waiting' AND request_type = 'edit'");
									$stmt_select_requests->execute();
									$requests = $stmt_select_requests->fetchAll(PDO::FETCH_ASSOC);
									?>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title"><?= lang("Add Bank Account") ?></h5>
								<h6 class="card-subtitle text-muted"></h6>
							</div>
							<div class="table-responsive">
								<table class="table table-striped">
									...
									$stmt_select_requests = $conn->prepare("SELECT * FROM user_requests WHERE status = 'waiting' AND (request_type = 'account' OR request_type = 'saving');");
									$stmt_select_requests->execute();
									$requests = $stmt_select_requests->fetchAll(PDO::FETCH_ASSOC);
									?>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title"><?= lang("Adding Cards") ?></h5>
								<h6 class="card-subtitle text-muted"></h6>
							</div>
							<div class="table-responsive">
								<table class="table table-striped">
									...
									$stmt_select_requests = $conn->prepare("SELECT * FROM user_requests WHERE status = 'waiting' AND request_type = 'card';");
									$stmt_select_requests->execute();	
									$requests = $stmt_select_requests->fetchAll(PDO::FETCH_ASSOC);
									?>

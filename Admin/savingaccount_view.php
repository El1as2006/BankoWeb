                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item dropdown ms-lg-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="savingaccount_view.php.php?lang=en"><i
                                            class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="savingaccount_view.php.php"><i
                                            class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="savingaccount_view.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown ms-lg-2">
                                <a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown"
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="table-action">
                        <form action="savingaccount.php?id=<?= $user_id ?>" method="post">
                            <button type="submit" class="btn btn-success"><?= lang("Create Account") ?></button>
                        </form>
                    </td>
                </tr>
            </tbody>

				...
				<div class="navbar-collapse collapse">
					...
					<li class="nav-item dropdown ms-lg-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="listingpurchases_view.php?lang=en"><i class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="listingpurchases_view.php?lang=es"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="listingpurchases_view.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                            </div>
                        </li>
...
// Consulta paginada
$stmt1 = $conn->prepare("SELECT * FROM purchases LIMIT :limit OFFSET :offset");
...
$stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM purchases");
$stmt2->execute();
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width:15%" data-sort="customer-account">
                            <?= lang("Customer Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:15%" data-sort="establishment-account">
                            <?= lang("Establishment Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:20%" data-sort="amount">
                            <?= lang("Amount") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th data-sort="date">
                        ...
                        <th style="width:20%" data-sort="description">
                            <?= lang("Description") ?>
                            <span class="sort-arrow"></span>
                        </th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($data as $row): ?>
                        <tr>
                            ...
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["customer_acn"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["establishment_acn"]) ?></td>

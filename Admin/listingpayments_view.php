				...
				<div class="navbar-collapse collapse">
					...
					<li class="nav-item dropdown ms-lg-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="listingpayments_view.php?lang=en"><i class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="listingpayments_view.php?lang=es"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="listingpayments_view.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
                            </div>
                        </li>
...
// Consulta paginada
$stmt1 = $conn->prepare("SELECT * FROM payments LIMIT :limit OFFSET :offset");
...
$stmt2 = $conn->prepare("SELECT COUNT(*) AS total FROM payments");
$stmt2->execute();
    ...
    <div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th style="width:5%;" data-sort="id-transference">
                            <?= lang("Id Transference") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:15%" data-sort="sender-email">
                            <?= lang("Sender Email") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:15%" data-sort="sender-account">
                            <?= lang("Sender Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:10%" data-sort="receiver-email">
                            <?= lang("Receiver Email") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:10%" data-sort="receiver-account">
                            <?= lang("Receiver Account") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th class="d-none d-md-table-cell" style="width:10%" data-sort="amount">
                            <?= lang("Amount") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:10%" data-sort="user">
                            <?= lang("User") ?>
                            <span class="sort-arrow"></span>
                        </th>
                        <th style="width:15%" data-sort="date">
                            <?= lang("Date") ?>
                            <span class="sort-arrow"></span>
                        </th>
                    </tr>
                ...
                <tbody>
                    <?php foreach ($data as $row): ?>
                        <tr>
                            <td class="d-none d-xl-table-cell"><?= $row["id_transfer"] ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["sender_email"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["sender_acn"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["receiver_email"]) ?></td>
                            <td class="d-none d-xl-table-cell"><?= decryptPayload($row["receiver_acn"]) ?></td>
                            <td class="d-none d-md-table-cell"><?= $row["amount"] ?></td>
                            <td class="d-none d-xl-table-cell"><?= $row["user"] ?></td>

					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								<a class="dropdown-item" href="addingcards.php?lang=en"><i
										class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="addingcards.php?lang=es"><i
										class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
										<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="addingcards.php?lang=de"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Deutsch</a>
							</div>
						</li>
						<li class="nav-item dropdown ms-lg-2">
							<a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown"
        ...
        <div class="table-responsive">
            <form method="POST">
                <table class="table table-striped">
                    ...
                    // Consulta paginada
                    $stmt1 = $conn->prepare("
                        SELECT u.*, a.accounttype, COUNT(cc.*) AS credit, COUNT(cd.*) AS debit, a.id AS accountId
                        FROM accounts a
                        JOIN users u ON a.owner_id = u.id
                        LEFT JOIN cards_credit cc ON cc.account_id = a.id
                        LEFT JOIN cards_debit cd ON cd.account_id = a.id
                        GROUP BY u.id, a.accounttype, a.id
                        ORDER BY u.id ASC
                    ...
                    <thead>
                        <tr>
                            <th style="width:15%;" data-sort="name">
                                <?= lang("Name") ?>
                            ...
                            <th style="width:25%" data-sort="dui">
                                DUI
                                <span class="sort-arrow"></span>
                            </th>
                            <th class="d-none d-md-table-cell" style="width:25%" data-sort="email">
                                Email
                                <span class="sort-arrow"></span>
                            </th>
                            <th class="d-none d-md-table-cell" style="width:25%" data-sort="type">
                                Type
                                <span class="sort-arrow"></span>
                            </th>
                            <th data-sort="credit">
                            ...
                            <tr>
                                ...
                                <td class="table-action">
                                    <?php if ($data["credit"] > 0): ?>
                                        <a href="creditcard_view.php?id=<?= $data['accountId']; ?>"
                                           class="btn btn-outline-primary"><?= lang("Credit Card") ?></a>
                                    <?php endif; ?>
                                </td>
                                <td class="table-action">
                                    <?php if ($data["debit"] > 0): ?>
                                        <a href="debitcard.php?id=<?= $data['accountId']; ?>"
                                           class="btn btn-outline-primary"><?= lang("Debit Card") ?></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php } ?>

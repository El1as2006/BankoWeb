					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								<a class="dropdown-item" href="edit_delete_view.php?lang=en"><i class="align-middle me-1 fas fa-fw fa-user"></i> English</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="edit_delete_view.php?lang=es"><i class="align-middle me-1 fas fa-fw fa-comments"></i> Español</a>
							</div>
						</li>
						<li class="nav-item dropdown ms-lg-2">
							<a class="nav-link dropdown-toggle position-relative" href="#" id="userDropdown" data-bs-toggle="dropdown">
									...
									<tbody>
										...
										foreach ($i as $data) { ?>
											<tr>
                                                ...
                                                <td class="table-action">
													<a href="deleteuser.php?id=<?php echo $data['id'];?>" class="btn btn-outline-primary"><?= Lang("Delete") ?></a>
												</td>
												<td class="table-action">
													<a href="deactivateuser.php?id=<?php echo $data['id'];?>" class="btn btn-outline-primary"><?= Lang("Desactivate") ?></a>
												</td>
												<td class="table-action">
													<a href="activateuser.php?id=<?php echo $data['id'];?>" class="btn btn-outline-primary"><?= Lang("Activate") ?></a>
												</td>
											</tr>
										<?php } ?>
									</tbody>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_check_username = $conn->prepare("SELECT * FROM users WHERE email = :email");
    $stmt_check_username->bindParam(':email', $email, PDO::PARAM_STR);
    ...
    $stmt_check_dui = $conn->prepare("SELECT * FROM users WHERE dui = :dui");
    $stmt_check_dui->bindParam(':dui', $dui, PDO::PARAM_STR);
    ...
    $stmt = $conn->prepare("INSERT INTO users (name, username, pass, address, dui, email, rol,state) VALUES (:name, :username, :password, :address, :dui, :email, :rol,:state)");
    ...
    $stmt->bindParam(':rol', $user_type, PDO::PARAM_STR);
    $stmt->bindParam(':state', $stat, PDO::PARAM_INT);

								...
								$i = $stmt->fetchAll(PDO::FETCH_ASSOC);                              
									...
									<thead>
										<tr>
											...
											<th style="width:15%"><?= lang("Customer Account") ?></th>
											<th style="width:15%"><?= lang("Establishment Account") ?></th>
											<th class="d-none d-md-table-cell" style="width:20%"><?= lang("Amount") ?></th>
											<th><?= lang("Date") ?></th>
									...
									<tbody>
                                        ...
                                        foreach ($i as $data) { ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-xl-table-cell">
                                                    <?php echo decryptPayload( $data["customer_acn"]) ?>
                                                </td>
                                                <td class="d-none d-xl-table-cell">
                                                    <?php echo decryptPayload($data["establishment_acn"] )?>
                                                </td>

									...
									<table class="table table-striped">
										...
										<thead>
											<tr>
												...
												<th class="d-none d-md-table-cell" style="width:25%">Type</th>
												<th><?= lang("Actions") ?></th>
											</tr>
										</thead>
										<tbody>
											...
											foreach ($i as $data) { ?>
												<tr>
													...
													<?php
													$debitClass = $data["debit"] > 0 ? "table-action" : "hidden";
													$creditClass = $data["credit"] > 0 ? "table-action" : "hidden";

													?>

													<td class="<?= $debitClass ?>">
														<?php if ($debitClass == "table-action"): ?>
															<a href="creditcard_view.php?id=<?php echo $data['accountid']; ?>"
																class="btn btn-outline-primary"><?= Lang("Credit Card") ?></a>
														<?php endif; ?>
													</td>

													<td class="<?= $creditClass ?>">
														<?php if ($creditClass == "table-action"): ?>
															<a href="debitcard.php?id=<?php echo $data['accountid']; ?>"
